...
namespace ProjectManager.Application.Projects.Queries.CreateProject
{
    public class CreateProjectQuery : IRequest<int>
    {
    ...
    public class CreateProjectHandler : IRequestHandler<CreateProjectQuery, int>
    {
        ...
        public async Task<int> Handle(CreateProjectQuery request, CancellationToken cancellationToken)
        {
