...
namespace ProjectManager.Application.ProjectTasks.Commands.ModifyTask.Validator
{
    public class ModifyTaskCommandValidator : AbstractValidator<ModifyTaskCommand>
    {
        public ModifyTaskCommandValidator()
        {
